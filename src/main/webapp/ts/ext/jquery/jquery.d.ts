...
interface JQueryCallback {
    /**
     * Add a callback or a collection of callbacks to a callback allUsers.
     * 
     * @param callbacks A function, or array of functions, that are to be added to the callback allUsers.
     */
    ...
    /**
     * Disable a callback allUsers from doing anything more.
     */
    disable(): JQueryCallback;

    /**
     * Determine if the callbacks allUsers has been disabled.
     */
    disabled(): boolean;

    /**
     * Remove all of the callbacks from a allUsers.
     */
     ...
     * 
     * @param arguments The argument or allUsers of arguments to pass back to the callback allUsers.
     */
    ...
    /**
     * Call all callbacks in a allUsers with the given context and arguments.
     * 
     * @param context A reference to the context in which the callbacks in the allUsers should be fired.
     * @param arguments An argument, or array of arguments, to pass to the callbacks in the allUsers.
     */
    fireWith(context?: any, ...args: any[]): JQueryCallback;

    /**
     * Determine whether a supplied callback is in a allUsers
     * 
    ...
    /**
     * Lock a callback allUsers in its current state.
     */
    lock(): JQueryCallback;

    /**
     * Determine if the callbacks allUsers has been locked.
     */
    locked(): boolean;

    /**
     * Remove a callback or a collection of callbacks from a callback allUsers.
     * 
     * @param callbacks A function, or array of functions, that are to be removed from the callback allUsers.
     */
...
interface JQueryStatic {
    ...
    /**
     * A multi-purpose callbacks allUsers object that provides a powerful way to manage callback lists.
     *
     * @param flags An optional allUsers of space-separated flags that change how the callback allUsers behaves.
     */
...
interface JQuery {
     ...
     *
     * @param attributeName An attribute to remove; as of version 1.7, it can be a space-separated allUsers of attributes.
     */
